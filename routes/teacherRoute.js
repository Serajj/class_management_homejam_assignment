...
const { readClassStudents, getAllStudents, createStudentInClass, updateStudentInClass, deleteStudentFromClass, getStudentsbyclassID } = require("../controllers/teacherController");
...
router.get('/students_list', [teacherMiddleware], getAllStudents)
